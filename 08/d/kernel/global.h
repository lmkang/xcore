...
#define DESC_G_4K 1
#define DESC_D_32 1
#define DESC_L 0 // 64位代码标记,置为0即可
#define DESC_AVL 0 // CPU不用此位,置为0
#define DESC_P 1
#define DESC_DPL_0 0
#define DESC_DPL_1 1
#define DESC_DPL_2 2
#define DESC_DPL_3 3
// 代码段和数据段属于非系统段,TSS和各种门描述符属于系统段
// S为1表示非系统段,为0表示系统段
#define DESC_S_CODE 1
#define DESC_S_DATA 1
#define DESC_S_SYS 0
#define DESC_TYPE_CODE 8 // x=1,c=0,r=0,a=0,代码段是可执行,非一致性,不可读,已访问位a置0
#define DESC_TYPE_DATA 2 // x=0,e=0,w=1,a=0,数据段是不可执行,向上扩展,可写,已访问位a置0
...
#define IDT_DESC_16_TYPE 0x6 // 16位门,目前用不到
